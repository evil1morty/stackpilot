...
<div class="overlay">
  <div class="modal">
    ...
    <div class="install-block">
      <p class="caption">Install Scoop with this PowerShell snippet:</p>
...
irm get.scoop.sh | iex</pre>
    ...
    <div class="actions">
      ...
      <button class="btn btn-primary" onclick={recheck} disabled={checking}>
        {checking ? "Checking…" : "I installed it · recheck"}
      </button>
    </div>

    <p class="hint">One-click install lands in Phase 2.</p>
  </div>
</div>
